"""noconflict
Module copied from http://www.phyast.pitt.edu/~micheles/python/metatype.html

Solves the metaclass conflict.

It exports the following method:
    * makecls: Class factory that avoids metatype conflicts.
"""
#<noconflict.py>
metadic={}
