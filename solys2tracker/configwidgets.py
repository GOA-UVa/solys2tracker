...
class ConnectionWidget(QtWidgets.QWidget):
    ...
    def _build_layout(self):
        ...
        self.add_checksum_label = QtWidgets.QLabel("Add Checksums:", alignment=QtCore.Qt.AlignLeft)
        self.add_checksum_label.setToolTip("Add checksum at the end of the Solys2 commands.\nNeeded for older models, but may fail with new ones.")
